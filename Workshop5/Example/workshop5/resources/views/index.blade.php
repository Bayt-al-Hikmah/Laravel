...
<body>
    ...
    <div class="container">
        ...
        <div id="login-view">
            ...
            <p class="auth-switch">
                Dont have an account? <a href="#" onclick="showRegister()">Register here</a>
            </p>
        ...
        <div id="app-view" style="display:none;">
            ...
            <nav class="app-nav">
                ...
                <div class="nav-links">
                    <button onclick="showTasks()" class="nav-btn active" id="btn-tasks">
                        Tasks
                    </button>
                    <button onclick="showProfile()" class="nav-btn" id="btn-profile">
                        Profile
                    </button>
